...
export default function HomePage() {
  ...
  const externalLinks: Link[] = [
    {
      name: "LinkedIn",
      description: messages.homePage.linkedinDescription,
      url: "https://www.linkedin.com/in/guilhermesilvadu",
      icon: <SiLinkedin className="fill-[#0077B5] dark:fill-zinc-200" />,
    },
    {
      name: "GitHub",
      description: messages.homePage.githubDescription,
      url: "https://github.com/AgiuG",
      icon: <SiGithub />,
    },
    // {
    //   name: "X (formerly Twitter)",
    //   description: messages.homePage.xDescription,
    //   url: "https://x.com/Guiig_a",
    //   icon: <XLogo />,
    // }
  ];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-center gap-6 max-sm:flex-col-reverse sm:justify-between">
        <div className="flex flex-col justify-center gap-4 max-sm:items-center">
          <div className="group -m-8 flex select-all items-center gap-3 p-8 transition-all">
            ...
            <div className="inline-flex items-center gap-3">
              ...
              <a
                href="mailto:guilhermeduarte19@gmail.com"
        ...
        <div className="flex flex-col gap-2">
          <a
            href="/guilherme-silva-cv.pdf"
            download="Guilherme-Silva-CV.pdf"
          ...
          >
            <span className="text-nowrap">{messages.homePage.resume}</span>
